...
mod bindings {
    wit_bindgen::generate!({
        ...
        with: {
            ...
            "wasi:clocks/monotonic-clock@0.2.4": generate,
            ...
            "wasi:random/insecure@0.2.4": generate,
            "wasi:random/insecure-seed@0.2.4": generate,
            "wasi:random/random@0.2.4": generate,
        },
    });
